...
############ change this path
$FlexAID_Command_base = "/home/padideh/projects/rrg-najmanov/padideh/FlexAID-Entropy/WRK. ".$config_file." ".$ga_file." ";
  ...
  if(!$log{$ligid."_".$nrun}){
    ...
    if(-e $runlog){
      ...
      if($run_code==0){
        ...
        print LOG $ligid,"_",$nrun," CF ",$cf," TIME ".$runtime, " smile ",$smile,"\n";
        close(LOG);
      }else{
...
sub write_CONFIG(){
  ...
  ############ change this path
  $outstring .= "IMATRX /home/padideh/projects/rrg-najmanov/padideh/FlexAID-Entropy/WRK/MC_st0r5.2_6.dat\n";
